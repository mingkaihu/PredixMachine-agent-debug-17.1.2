...
SET SHUTDOWNCLIENT=%PREDIX_MACHINE_DATA%\machine\bin\predix\com.ge.dspmicro.shutdown-hook-client-17.1.2.jar
SET SECURITYADMIN=%PREDIX_MACHINE_DATA%\machine\bundles\com.ge.dspmicro.securityadmin-17.1.2.jar
