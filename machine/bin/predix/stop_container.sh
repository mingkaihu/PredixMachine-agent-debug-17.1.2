...
# If it doesn't have ps aux use the shutdown hook, will spawn another JVM
	...
	while true; do
		...
		java -cp "$PREDIX_MACHINE_DATA"/machine/bundles/com.ge.dspmicro.securityadmin-17.1.2.jar:"$PREDIX_MACHINE_DATA"/machine/bin/predix/com.ge.dspmicro.shutdown-hook-client-17.1.2.jar com.ge.dspmicro.shutdownhookclient.ShutdownHookClient
